...
<div class="container mt-5">
    ...
    <form action="<%= request.getContextPath() %>/users/update" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="identificationDocument" name="identificationDocument" value="<%= user.identificationDocument() %>" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="registrationDate" name="registrationDate" value="<%= user.registrationDate() %>" required>
        </div>
        <div class="mb-3">
            <label for="expirationDate" class="form-label">Expiration Date</label>
            <input type="date" class="form-control" id="expirationDate" name="expirationDate" value="<%= user.expirationDate() %>" required>
        </div>
